...
while True:
    ...
    # index = df.set_index('card_number')
    ...
    if status.empty:
        ...
        if status[index] == 'Active':
            ...
            transaction_dict = {'trans_ID': [new_trans_id], 'trans_date': [today], 'time': [''], 'tran_type': [''], 'trans_amt': [''], 'card_number': [input_card_num], 'trans_status': ['']}
